...
public:
        ...
        bool shader;//false-height,true-material //TODO
        int lodFactor;
        bool isMousePressed;bool isLeftMouse;
        Map* map;
        OgreBites::Label* caption;
        char mode;//0-height,1-material,2-buildings,3-spectate
        int material;
        int building;//TODO buildings, caves
